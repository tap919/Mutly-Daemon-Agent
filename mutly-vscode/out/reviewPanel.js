...
exports.MutlyReviewPanel = void 0;
const vscode = require("vscode");
class MutlyReviewPanel {
    extensionUri;
    client;
    static viewType = 'mutly.reviewPanel';
    _view;
    lastReview = null;
    disposables = [];
...
<script>
  ...
  function runReview() { vscode.postMessage({ command: 'runReview' }); }
        ...
        const colorFor = (s) => s >= 80 ? '#4caf50' : s >= 60 ? '#ff9800' : '#f44336';
        return `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'unsafe-inline'; script-src 'unsafe-inline'; img-src ${cspSource} data:; font-src ${cspSource};">
...
exports.MutlyReviewPanel = MutlyReviewPanel;
